...
$data_formatada = date('d-m-Y', strtotime($row['nascimento'])); */
?>
...
<head>
    ...
    <link rel="stylesheet" href="css/media_perfil.css">
</head>
<body>
<main>
    <div class="menu">
      <div class="title">
        ...
        <a href="pesquisa.php"><h3>HELLO WORLD</h3></a>
      </div>
      
      <div class="foto-perfil">
        <span class="exibir_nome"><?php echo 'Bem vindo, ' , $row['nome']?></span>
      </div>
      <div class="sub-menu">
        <h3 class="option"> 
    ...
    <div id="dados">
      ...
      <header>
        ...
        <form method="POST" action="" id="form1">
          <div class="dados-title"><h2 class="content-title"><a id="anchor-1">DADOS PESSOAIS</a></h2></div>
          <hr>
          <div class="nome">
            <small class="input-title"> Nome Completo:</small> <br>
            <input type = "text"  id="nome-completo" name="nome"  placeholder="Digite o nome completo.."  class="input require" value="<?php echo $row['nome'] ?>" readonly/>
          </div>
          <br>
          <div class="nascimento">
            <small class="input-title">Data de nascimento:</small> <br>
            <input type="date"  id="data-nascimento" name="nascimento" placeholder="Digite a data de nascimento.." value="<?php echo isset($data_formatada) ? $data_formatada : ''; ?>" readonly/>
          </div>
          <div class="sexo">
            <small class="input-title"> Gênero</small><br>
            <select name="genero" id="Gênero"  value="<?php echo $row['genero'] ?>" disabled>
          ...
          <div class="nome-materno">
            ...
            <input type="text"  id="nome-materno" name="nome_materno" placeholder="Digite o nome da sua mãe.."  class="input require" value="<?php echo $row['nome_materno'] ?>" readonly/>
          </div>
          <br>
          <div class="cpf">
            <small class="input-title">CPF:</small><br>
            <input type="number" id="cpf" name="cpf" placeholder="Digite o seu CPF.." class="input require"  value="<?php echo $row['cpf'] ?>" readonly/>
          </div>
          <div class="email">
            <small calss="input-title">E-mail:</small><br>
            <input  type="email"  id="email" name="email" placeholder="Digite o seu email.." class="input require"  value="<?php echo $row['email'] ?>" readonly/>
          </div>
          <br>
          <div class="celular">
            <small class="input-title">Celular:</small><br>
            <input type="number" id="celular" name="celular" placeholder="Digite o seu telefone celular.." class="input require"  value="<?php echo $row['celular'] ?>" readonly/>
          </div>
          
          <div class="tel-fixo">
            <small class="input-title">Telefone fixo:</small><br>
            <input type="number"  id="tel-fixo" name="telefone" placeholder="Digite o seu telefone fixo.." class="input require" value="<?php echo $row['telefone'] ?>" readonly/>
          </div>
          <br>
          <div class="senha">
            <small class="input-title">Senha:</small><br>
            <input  type="password"  id="senha" name="senha" placeholder="Digite a sua senha.."class="input require" value="<?php echo $row['senha'] ?>" readonly/>
          </div>
          
          <div class="confirmar-senha">
            <small class="input-title">Confime sua senha:</small><br>
            <input type="password"  id="confirmar-senha" name="confirmar_senha" placeholder="confirme sua senha.."  class="input require" value="<?php echo $row['confirmar_senha'] ?>" readonly />
          </div><br>
      </div>
      <br>
      <div>
        <a id="anchor-2"></a>
        <div class="endereco">
          <div class="dados-title"><h2 class="content-title">ENDEREÇO</h2></div>
          <hr>
          <div class="cep">
            <small class="input-title">CEP:</small><br>
              <input type="text" id="cep" name="cep" placeholder="Digite seu CEP" value="<?php echo $row['cep'] ?>" readonly>
            <span class="span-required"></span>
          </div><form>
          <div class="uf">
            <small class="input-title">UF:</small><br>
            <input type="text" id="uf" name="uf" placeholder="'RJ'"  class="input require" value="<?php echo $row['uf'] ?>" readonly>
            <span class="span-required"></span>
          </div>
          <br>
          <div class="logadouro">
            <small class="input-title">Logradouro:</small><br>
            <input type="text" id="logadouro" name="logradouro" placeholder="Digite seu endereço completo"  class="input require" value="<?php echo $row['logradouro'] ?>" readonly>
            <span class="span-required"></span>
          </div>
          <br>
          <div class="numero">
            <small class="input-title">Número:</small><br>
            <input type="text" id="numero" name="numero" placeholder="Num. da residência" class="input require" value="<?php echo $row['numero'] ?>" readonly>
            <span class="span-required"></span>
          </div>
          
          <div class="complemento">
            <small class="input-title">Complemento:</small><br>
            <input type="text" id="complemento" name="complemento" placeholder="Exemplo(Apt:402)"  class="input require" value="<?php echo $row['complemento'] ?>" readonly>
            <span class="span-required"></span>
          </div>
          <br>
          <div class="bairro">
            <small class="input-title">Bairro</small><br>
            <input type="text" id="bairro" name="bairro" placeholder="Bairro em que reside" class="input require" value="<?php echo $row['bairro'] ?>" readonly>
            <span class="span-required"></span>
          </div>
          <div class="localidade">
            <small class="input-title">Localidade</small><br>
            <input type="text" id="localidade" name="localidade" placeholder="Municipío em que reside"  class="input require" value="<?php echo $row['localidade'] ?>" readonly>
            <span class="span-required"></span>
          </div>
          <br>
      ...
      <div>
        <a id="anchor-3"></a>
          <div class="curriculo">
            <div class="dados-title"><h2 class="content-title">Currículo</h2></div>
            <hr>
            ...
            <div class="nivel">
              ...
              <select name="senioridade" id="nivel"  value="<?php echo $row['senioridade'] ?>" disabled>
            ...
            <div class="linguagens">
              ...
              <div class="front">
                <div><input type="checkbox" id="html" name="cad[]" value="html" value="<?php if($row['html'] == 1) echo 'checked'; ?>" disabled >
                ...
                <div><input type="checkbox" id="css" name="cad[]" value="css" value="<?php if($row['css'] == 1) echo 'checked'; ?>" disabled>
                ...
                <div><input type="checkbox" id="javascript" name="cad[]" value="javascript" value="<?php if($row['javascript'] == 1) echo 'checked'; ?>" disabled>
              ...
              <div class="front">
                ...
                <div><input type="checkbox" id="c++" name="cad[]" value="c" value="<?php if($row['c'] == 1) echo 'checked'; ?>" disabled>
                ...
                <div><input type="checkbox" id="python" name="cad[]" value="python" value="<?php if($row['python'] == 1) echo 'checked'; ?>>" disabled>
                ...
                <div><input type="checkbox" id="java" name="cad[]" value="java" value="<?php if($row['java'] == 1) echo 'checked'; ?>" disabled>
                ...
                <div><input type="checkbox" id="php" name="cad[]" value="php" value="<?php if($row['php'] == 1) echo 'checked'; ?>" disabled>
            ...
            <div class="bio">
              ...
              <textarea id="bio" name="apresentacao" placeholder="Fale um pouco sobre você, experiências, qualidades e como você pode colaborar com as equipes de desenvolvedores"  rows="10" cols="100" maxlength="1000" wrap="soft" value="<?php echo $row['bio'] ?>" readonly></textarea>
            </div>
            ...
            <div class="linkedin">
              ...
              <input type="url" name="linkedin" id="linkedin" placeholder="Coloque o link do seu perfil do LinkedIn" value="<?php echo $row['linkedin'] ?>" readonly>
            </div>

            <div class="github">
              <small class="input-title">Github:</small><br>
              <input type="url" name="github" id="github" placeholder="Coloque o link do seu Github" value="<?php echo $row['github'] ?>" readonly>
            </div>
            <br>
          </div>      
          <div class="botao">
            <button type="submit" class="bt-enviar" name="submit" id="btnEnviar">Enviar</button>
...
document.querySelector('.editar').addEventListener('click', function() {
  ...
  for (var i = 0; i < formulario.elements.length; i++) {
    // Verifica se o campo possui o atributo "readonly"
    if (formulario.elements[i].hasAttribute('readonly')) {
      // Remove o atributo "readonly" e habilita o campo para edição
      formulario.elements[i].removeAttribute('readonly');
